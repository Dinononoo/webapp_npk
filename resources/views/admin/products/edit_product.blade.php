        ...
        <div class="card-body p-4">
            ...
            <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    @if ($product->image)
                        <div class="mt-2">
                            <img id="currentImage" src="{{ asset('storage/' . $product->image) }}" alt="Product Image" class="img-thumbnail" style="max-height: 200px;">
                        </div>
                    @endif
                    <div class="mt-2">
...
<style>
    ...
    .input-group input[type="file"]:focus ~ .input-group-text::after {
        content: "✓";
        color: #fff;
        font-size: 1.5rem;
        margin-left: 0.5rem;
