...
<div class="container mt-4">
    <div class="card shadow-sm border-0">
        <div class="card-header d-flex justify-content-between align-items-center text-white rounded-top border-0" style="background: linear-gradient(135deg, #4b6cb7, #182848);">
            <h5 class="mb-0">เพิ่มเซ็นเซอร์</h5>
        ...
        <div class="card-body p-4">
            <form action="{{ route('admin.sensors.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="sensor_id" id="sensor_id" class="form-control" required>
                </div>
                <button type="submit" class="btn btn-primary d-flex align-items-center">
                    <i class="fas fa-plus me-2"></i> เพิ่มเซ็นเซอร์
                </button>
            </form>
        </div>
    </div>
